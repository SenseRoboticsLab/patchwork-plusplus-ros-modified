...
#include "patchworkpp/nanoflann.hpp"
#include "patchworkpp/nanoflann_utils.hpp"
...
void saveLabels(const std::string abs_dir, const int frame_num,
  ...
  // Labels are set in the intensity of `labeled_pc`, which is larger than 0.
  // i.e. > 0
  ...
  using my_kd_tree_t = nanoflann::KDTreeSingleIndexAdaptor<
      nanoflann::L2_Simple_Adaptor<num_t, PointCloud<num_t>>, PointCloud<num_t>,
      3 /* dim */
      >;
  ...
  output_file.write(reinterpret_cast<char *>(&labels[0]),
                    num_cloud_in * sizeof(uint32_t));
}
